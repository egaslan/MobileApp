...
export default class News extends React.Component {
    ...
    static navigationOptions = {
        ...
        drawerIcon: ({tintColor}) => (
            <Icon name="ios-paper" style={{fontSize:24, color: tintColor}}/>
        )
    }
    constructor(props){
        super(props);
                    ...
                    <ScrollView>
                        {data.map((item,index)=>{
                            if(item.ed_gallery_news_title!=null){
                                return (
                                    <TouchableOpacity onPress={()=> this.props.navigation.navigate('New_Detail',{
                                    ...
                                    page:"News",
                                        ...
                                        <View>
                                            ...
                                            <Image
                                                ...
                                                source={{uri: 'https://xxxxxx/'+ item.image}}  //YOUR API URL 
                                            />
                                                <View>
                                                    <Text style={{ fontSize: 18,fontWeight: 'bold', textAlign: 'left', margin:(5,5,0,5) }}>{item.ed_gallery_news_title} </Text>
                                                    <Text style={{ fontSize: 14, textAlign: 'left', margin:(0,5,5,5) }}>{item.ed_gallery_news_subtitle} </Text>
